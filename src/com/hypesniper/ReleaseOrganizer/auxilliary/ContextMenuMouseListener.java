/*
this script enables contex menu for text areas
this listener is added as right click mouse listener for text inputs
so undo, cut, copy, paste operations will be seen on rightClick
*/
